...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is TRZXProjectDetail
                   DESC

  s.homepage     = "https://github.com/TRZXDev/TRZXProjectDetail.git"
  ...
  s.source       = { :git => "https://github.com/TRZXDev/TRZXProjectDetail.git", :tag => s.version.to_s }
